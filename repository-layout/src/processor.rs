use crate::modules::instructions::eat_food::eat_food;
use crate::modules::instructions::get_on_ride::get_on_ride;
use crate::modules::instructions::play_game::play_game;
use crate::modules::instructions::{eat_food, get_on_ride, play_game};
...
pub fn process_instruction(
    ...
    match ix_data_object.attraction.as_str() {
        "ride" => get_on_ride(get_on_ride::GetOnRideInstructionData {
